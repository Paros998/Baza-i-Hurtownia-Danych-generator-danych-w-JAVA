...
CREATE TABLE uprawnienia (
    uprawnienie_id NUMBER(6) PRIMARY KEY,
    oznaczenie VARCHAR2(4)NOT NULL,
    opis VARCHAR2(50)
);

CREATE TABLE specjalnosci (
    specjalnosc_id NUMBER(6) PRIMARY KEY,
...
CREATE TABLE kontakty(
    kontakt_id NUMBER(6) PRIMARY KEY,
...
CREATE TABLE placowki(
    placowka_id NUMBER(6) PRIMARY KEY,
    nazwa VARCHAR2(45),
...
CREATE TABLE pracownicy(
    pracownik_id NUMBER(6) PRIMARY KEY,
    ...
    adres_id NUMBER(6) NOT NULL,
    kontakt_id NUMBER(6) NOT NULL,
    stanowisko_id NUMBER(6) NOT NULL,
    specjalnosc_id NUMBER(6),
...
CREATE TABLE pacjenci(
    pacjent_id NUMBER(6) PRIMARY KEY,
    imie VARCHAR2(100) NOT NULL,
    nazwisko VARCHAR2(100) NOT NULL,
    login VARCHAR2(150),
    haslo VARCHAR2(150),
...
CREATE TABLE ulgi (
    ulgi_id NUMBER(6) PRIMARY KEY,
    typ_ulgi VARCHAR(45) NOT NULL,
    procent_ulgi NUMBER(3)
);

CREATE TABLE oddzialy_nfz (
    oddzial_nfz_id NUMBER(6) PRIMARY KEY,
    nazwa VARCHAR2(100) NOT NULL,
    kod_funduszu VARCHAR2(3) NOT NULL
);

CREATE TABLE wizyty(
    wizyta_id NUMBER(6) NOT NULL PRIMARY KEY,
    oplata NUMBER(6) NOT NULL,
    data_wizyty DATE NOT NULL,
    godzina_poczatek VARCHAR2(5) NOT NULL,
    godzina_koniec VARCHAR2(5),
    pacjent_id NUMBER(6) NOT NULL,
    prac_spec NUMBER(6) NOT NULL,
    prac_uma NUMBER(6) NOT NULL,
    gabinet_id NUMBER(6) NOT NULL,
...
CREATE TABLE recepty (
    recepta_id NUMBER(6) PRIMARY KEY,
    pracownik_id NUMBER(6) NOT NULL,
...
CREATE TABLE pozycje_recept (
    pozycje_recept_id NUMBER(10) PRIMARY KEY,
    recepta_id NUMBER(6) NOT NULL,
    nazwa VARCHAR2(100) NOT NULL,
...
CREATE TABLE zabiegi (
    zabieg_id NUMBER(6) PRIMARY KEY,
...
CREATE TABLE statusy_wizyt (
    statusy_wizyt_id NUMBER(6) PRIMARY KEY,
